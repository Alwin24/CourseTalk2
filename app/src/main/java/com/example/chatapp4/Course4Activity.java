...
public class Course4Activity extends AppCompatActivity {   // change here
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_course4); // change here
            ...
            AuthUI.getInstance().signOut(this)
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            Toast.makeText(Course4Activity.this, // change here
    ...
    public void goToProfile(MenuItem item) {
        startActivity(new Intent(Course4Activity.this, Profile.class)); //change this
    }
}